    ...
    return (
        <div>
            ...
            <section id='login__'>
                ...
                <div>
                    <h2>Login</h2>
                    <form class="login__" onSubmit={handleLogin}>
                        <input type="text" className={err == '' ? 'not__err':'error__'} onChange={e=>{setEmail(e.target.value)}} placeholder="Username"/>
                        <p class="error username-error">{err}</p>
                        <input type="password" className={err == '' ? 'not__err':'error__'} onChange={e=>{setPwd(e.target.value)}} placeholder="Password"/>
                        <p class="error username-error">{err==''?null:err}</p>
