                ...
                <div class="container">
                    ...
                    </ul>
                    {
                        ...
                        <ul class="navbar-nav ms-auto ">
                            ...
                            <li class="nav-item">
                            <Link to='/register' class="nav-link mx-2 text-uppercase" href="#"><i class="fa-solid fa-circle-user me-1"></i>S'inscrire</Link>
                            </li>
                        </ul>
                        :
                        ...
                        <ul class="navbar-nav ms-auto ">
                            <li class="nav-item">
                                <Link to='/profile' class="nav-link mx-2 text-uppercase" ><i class="fa-solid fa-cart-shopping me-1"></i>Sel your product</Link>
                            </li>
                            <li class="nav-item">
                            <Link to='/cart' class="nav-link mx-2 text-uppercase" ><i class="fa-solid fa-cart-shopping me-1"></i> Cart</Link>
                            </li>
                            <li class="nav-item">
                            <Link to='/profile'  class="nav-link mx-2 text-uppercase" href="#"><i class="fa-solid fa-circle-user me-1"></i> Account</Link>
                            </li>
                        </ul>
