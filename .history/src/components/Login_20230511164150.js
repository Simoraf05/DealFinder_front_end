            ...
            <section id='login__'>
                ...
                <div>
                    ...
                    <form class="login" onSubmit={handleLogin}>
                        <input type="text" value={formik.initialValues.email} onChange={e=>{setEmail(e.target.value)}} placeholder="Username"/>
                        <input type="password" value={formik.initialValues.email} onChange={e=>{setPwd(e.target.value)}} placeholder="Password"/>
