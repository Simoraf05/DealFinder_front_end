            ...
            <section id='login__'>
                ...
                <div>
                    ...
                    <form class="login" onSubmit={handleLogin}>
                        <input type="text" className={!email == '' ? 'not__err':'error__'} onChange={e=>{setEmail(e.target.value)}} placeholder="Username"/>
                        <p class="error username-error">{err}</p>
                        <input type="password" className={!pwd == '' ? 'not__err':'error__'} onChange={e=>{setPwd(e.target.value)}} placeholder="Password"/>
                        <p class="error username-error">{err</p>
