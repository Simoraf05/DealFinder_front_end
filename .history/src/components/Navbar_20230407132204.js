                ...
                <div class="container">
                    ...
                    </ul>
                    {
                        ...
                        <ul class="navbar-nav ms-auto ">
                            ...
                            <li class="nav-item">
                            <Link to='/monC'  class="nav-link mx-2 text-uppercase" ><i class="fa-solid fa-circle-user me-1"></i> Account</Link>
                            </li>
                            <div class="dropdown">
                                ...
                                id="navbarDropdownMenuLink" role="button" data-bs-toggle='dropdown' aria-expanded="false">
                                {
                                    ...
                                    alt="" loading="lazy" />
                                    :
                                    <img src=src={`http://localhost:8000/`+data.profile_picture} class="rounded-circle" height="22"
                                    alt="" loading="lazy" />
                                }
                                </a>
