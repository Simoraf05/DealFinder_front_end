...
const Register = () => {
  ...
  return (
    <div>
    <Headrer></Headrer>
    <section id='register__'>
        <img src='images/about/a6.jpg' />
        <div>
            <h2>Login</h2>
            <form className="register__" onSubmit={handleRegister}>
                <input type="text" onChange={e=>{setName(e.target.value)}} placeholder="Username"/>
                <input type="password" onChange={e=>{setEmail(e.target.value)}} placeholder="email"/>
                <input type="password" onChange={e=>{setPhone(e.target.value)}} placeholder="Phone"/>
                <input type="password" onChange={e=>{setPwd(e.target.value)}} placeholder="Password"/>
                <input type="password" onChange={e=>{setCpwd(e.target.value)}} placeholder="Confirme Password"/>
                    ...
                    <div class="card text-black" >
                        ...
                        <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                            ...
                            <i class='fas fa-phone-alt fa-lg me-3 fa-fw'></i>
                                ...
                                <div class="form-outline flex-fill mb-0">
                                <input onChange={e=>{setPhone(e.target.value)}} type="text" id="form3Example1c" class="form-control" />
