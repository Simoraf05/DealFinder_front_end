                ...
                <div class="container">
                    ...
                    </ul>
                    {
                        ...
                        <ul class="navbar-nav ms-auto ">
                            ...
                            <li class="nav-item">
                            <Link to='/profile'  class="nav-link mx-2 text-uppercase" ><i class="fa-solid fa-circle-user me-1"></i> Account</Link>
                            </li>
                            <div class="dropdown">
                                ...
                                id="navbarDropdownMenuLink" role="button" data-bs-toggle='dropdown' aria-expanded="false">
                                {
                                    ...
                                    <img src='https://st3.depositphotos.com/15648834/17930/v/600/depositphotos_179308454-stock-illustration-unknown-person-silhouette-glasses-profile.jpg' class="rounded-circle" height="22"
                                    alt="" loading="lazy" />
                                    :
                                    <img src={currentUser.profile_picture} class="rounded-circle" height="22"
                                    alt="" loading="lazy" />
                                }
                                </a>
