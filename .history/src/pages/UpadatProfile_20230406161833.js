  ...
  const UpadatProfile = () => {
    ...
    const handleUpdate = (event) => {
      ...
      axios.put(`http://127.0.0.1:8000/api/updateProfile/${data.id}`,dataToUpdate,{headers: { 'Content-Type': 'multipart/form-data' }})
        .then((response) => {
                  ...
                  <form role="form" onSubmit={handleUpdate} className='form__updateP'>
                    <div class="box-body">
                      ...
                      <div class="form-group">
                        ...
                        <input onChange={(e) => handelImage(e.target.value)} class="form-control form-control-lg" id="formFileLg" type="file" />
