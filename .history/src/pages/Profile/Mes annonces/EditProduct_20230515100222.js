        ...
        <div>
            ...
            <div class="row align-items-center pt-4 pb-3">
                ...
                <div class="col-md-12 pe-5">
                    <input type="text"  class="form-control form-control-lg" defaultValue={props.items.title} onChange={e=>{setTitle(e.target.value)}} />
                </div>
            </div>
            ...
            <div class="row align-items-center pt-4 pb-3">
                ...
                <div class="col-md-12 pe-5">
                    <input type="text" onChange={e=>{setDescription(e.target.value)}} defaultValue={props.items.description} class="form-control form-control-lg" />
                </div>
            </div>
            ...
            <div class="row align-items-center pt-4 pb-3">
                ...
                <div class="col-md-12 pe-5">
                    <input type="number" onChange={e=>{setPrice(e.target.value)}} defaultValue={props.items.price} class="form-control form-control-lg" />
                </div>
            </div>
            ...
            <div class="row align-items-center pt-4 pb-3">
                ...
                <div class="col-md-12 pe-5">
                    <input type="text" onChange={e=>{setShipping_option(e.target.value)}} defaultValue={props.items.shipping_options} class="form-control form-control-lg" />
                </div>
            </div>
