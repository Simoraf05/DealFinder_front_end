            ...
            <tbody>
              {
                myProducts.map((item) => (
                  <tr>
                    ...
                    <td>${item.price}</td>
                    <td>
                      <button class="btn btn-outline-success btn-sm btn__" onClick={() => { editeProduct(item.id) }} data-abc="true">Edite</button>
                    </td>
                    <td>
                      <button class="btn btn-outline-danger btn-sm" onClick={deleteProduct} data-abc="true">Delete</button>
                    </td>
                  </tr>
                ))
              }
