...
const MesAnn = () => {
  ...
  const editeProduct = ({ 
    ...
    toast(<EditProduct items={{title:title,description:description,price:price,Product_image:Product_image,ipping_options:shipping_options,Category:Category}}></EditProduct>
      , {
        position: "top-center",
        autoClose: 5000,
