...
const MesAnn = () => {
  ...
  const editeProduct = ({ title: title,
    ...
    toast(<EditProduct items={data}></EditProduct>
      , {
        position: "top-center",
        autoClose: 5000,
            ...
            <tbody>
              {
                myProducts.map((item) => (
                  <tr>
                    ...
                    <td>${item.price}</td>
                    <td>
                      <button class="btn btn-outline-success btn-sm btn__edit" onClick={() => { editeProduct({id:item.id,      title:title,
      description:description,
      price:price,
      Product_image:Product_image,
      shipping_options:shipping_options,
      Category:Category}) }} data-abc="true">Edite</button>
                    </td>
                    <td>
