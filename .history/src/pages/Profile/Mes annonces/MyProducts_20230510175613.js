...
()=>{editeProduct}                        <button class="btn btn-outline-success btn-sm" onClick={()=>{editeProduct}} data-abc="true">Edite</button>
                        <button class="btn btn-outline-danger btn-sm" onClick={} data-abc="true">Delete</button>
                      </div>
                    </div>
                </div>
              </div>
