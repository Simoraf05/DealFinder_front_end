        ...
        <div class="row myInfo__">
          ...
          <div class="col-6 border-right form__">
            <div class="p-3 py-5 info__inputs">
              ...
              <div class="row mt-3">
                <div class="col-md-6"><label class="labels">Name</label><input defaultValue={currentUser.name} onChange={e=>{setName(e.target.value)}} type="text" placeholder="name" value="" /></div>
                ...
                <div class="col-md-6"><label class="labels">Email</label><input defaultValue={currentUser.email} type="text" onChange={e=>{setEmail(e.target.value)}} placeholder="email" value="" /></div>
              </div>
              <div class="row mt-3">
