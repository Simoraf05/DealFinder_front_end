...
const MesOff = () => {
  ...
  const updateOfferStatus = ({offer_id:offer_id, id:id}) => {
            ...
            <tbody>
              {
                offer.map((item) => (
                  <tr>
                    ...
                    <td>${item.price}</td>
                    <td>
                      <button type="button" onClick={()=>{updateOfferStatus({offer_id:item.offer_id,id:item.idP})}} class="btn btn-secondary">Update</button>
                    </td>
                    <td>
                      {
