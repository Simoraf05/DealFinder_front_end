              ...
              commande.map((item) => (
                <tr>
                  ...
                  <td><input type='number' defaultValue={item.offer_price} /></td>
                  {
                    ...
                    <td>                      <button type="button" onClick={() => { updateOfferPrice(item.offer_id) }}>update offer price</button>
                    </td>
                      :
                      <button type="button" onClick={() => { checkO({ name: item.title, price: item.offer_price, product_image: item.product_image, seller_name: item.seller_name, seller_id: item.seller_id, buyer_id: currentUser.id, product_id: item.idP }) }}>CheckOut</button>
                  }
