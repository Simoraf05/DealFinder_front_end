...
//e.preventDefault()
  ...
  <input type='number' onChange={e=>{setNewPrice(e.target.value)}} defaultValue={item.offer_price} class="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1"/>
</div>
                  </td>
                  <td>${item.status}</td>
                  {
