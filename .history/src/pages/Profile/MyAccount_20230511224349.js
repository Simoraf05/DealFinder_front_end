        ...
        <div class="row myInfo__">
          <div class="col-md-3 border-right">
            <div class="d-flex flex-column align-items-center text-center p-3 py-5" id='profile__picture'>
              ...
              <span class="text-black-50">{currentUser.name}</span>
              <span> </span>
            </div>
            <div id="avatar-edit">
          ...
          <div class="col-6 border-right">
            <div class="p-3 py-5 info__inputs">
              ...
              <div class="row mt-3">
                ...
                <div class="col-md-6"><label class="labels">Email</label><input type="text"  onChange={e=>{setEmail(e.target.value)}} placeholder="enter email" value="" /></div>
              </div>
              <div class="row mt-3">
