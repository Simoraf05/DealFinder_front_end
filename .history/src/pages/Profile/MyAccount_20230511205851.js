        ...
        <div class="row myInfo__">
          ...
          <div class="col-6 border-right">
            <div class="p-3 py-5 info__inputs">
              ...
              <div class="row mt-3">
                <div class="col-sm-12"><label class="labels">Mobile Number</label><input type="text"  placeholder="enter phone number" value="" /></div>
                <div class="col-md-12"><label class="labels">Address Line 1</label><input type="text"  placeholder="enter address line 1" value="" /></div>
                <div class="col-md-12"><label class="labels">Email</label><input type="text"  placeholder="enter email" value="" /></div>
              </div>
              <div class="row mt-3">
