          ...
          <div class="col-6 border-right">
            <div class="p-3 py-5 info__inputs">
              ...
              <div class="row mt-3">
                ...
                <div class="col-md-6"><label class="labels">Mobile Number</label><input onChange={e=>{setName(e.target.value)}} type="text" placeholder="enter phone number" value="" /></div>
                <div class="col-md-6"><label class="labels">Address Line 1</label><input  onChange={e=>{setName(e.target.value)}}type="text" placeholder="enter address line 1" value="" /></div>
