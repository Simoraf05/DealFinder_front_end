...
const MesOff = () => {
    ...
    const updateOffer=(offer_id)=>{
      axios.put(`http://127.0.0.1:8000/api/updatingOffer/${offer_id}`)
    }
    console.log(offer)
  return (
    <div>
                            ...
                            <div class="row d-flex justify-content-between align-items-center">
                              ...
                              <div id='validat__btn' class="col-md-2 col-lg-1 col-xl-1 text-end">
                                <div class="col-md-9">
                                  ...
                                  <button type="submit" onClick={()=>{updateOffer(item.offer_id)}} class="btn btn-primary btn-lg">Publish</button>
                                </div>                              
                              </div>
                            </div>
                          </div>
