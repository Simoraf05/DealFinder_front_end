        ...
        <div>
            ...
            <section id='productdetail__'>
                <div className='single__pro__image'>
                    <img src={`http://localhost:8000/` + location.state.image} width='100%' id='MainImg__'/>
                </div>
                <div className='single__pro__details'>
                    <h6>Home / {location.state.title}</h6>
                    <h4>{location.state.categor}</h4>
                    <h2>Starting from $132</h2>
                    <button className='normal__'>Add To Cart</button>
                    <h4>Product Details</h4>
                    <span>Le Lorem Ipsum est simplement du faux texte employé dans la composition
                    </span>
                </div>
            </section>
