...
const FiltringProducts = () => {
    ...
    const dataArray = Object.entries(categories)
        ...
        const dataFetch = async () =>{
          const products = awa(await fetch('http://127.0.0.1:8000/api/filtring',title))
            ...
            <div class="row" id="search">
                <form id="search-form" action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-xs-3">
                        <button type="submit" onClick={dataFetch} class="btn btn-block btn-primary">Search</button>
                    </div>
                </form>
            </div>
