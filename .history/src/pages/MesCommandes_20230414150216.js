                              ...
                              <div class="col-md-3 col-lg-2 col-xl-2 offset-lg-1">
                                {
                                    ...
                                    :
                                    <button type="button" onClick={()=>{checkO({name:item.title,price : item.offer_price,product_image : item.product_image,seller_name:item.seller_name,product_id:item.idP})}} class="btn btn-primary">CheckOut</button>
                                }
