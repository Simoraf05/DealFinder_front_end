                    ...
                    <div class="row">
                      ...
                      <h5>Quant trident shirts</h5>
                        <div class="d-flex flex-row">
                          ...
                          <div id='tooltip_product' class="mt-1 text-muted small">
                              <div id='seller_info'>
                                <p id='seller_info_name'><span class="text-white">name: </span>{item.seller_name}</p>
                                <p id='seller_info_email'><span class="text-white">email: </span>{item.seller_email}</p>
                              </div>
