            ...
            <div class="container h-100">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="Email" onChange={e=>{setPwd(e.target.value)}} class="form-control"  placeholder="Enter Password"/>
                </div>
                
                <div class="form-group">
                  <label>Confirm Password</label>
                  <input type="Email" onChange={e=>{setEmail(e.target.value)}} class="form-control"  placeholder="Renter Password"/>
                </div>
