                    ...
                    <div class="col-3">
                      <div class="card mb-30"><a class="card-img-tiles" href="#" data-abc="true">
                        ...
                        <div class="card-body text-center">
                          ...
                          <p class="text-muted">Starting from ${item.price}</p><button class="btn btn-outline-primary btn-sm" onClick={()=>{productD(item)}} data-abc="true">View Products</button>
                        </div>
                      </div>
                    </div>
                  </div>
