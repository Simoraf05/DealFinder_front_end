  ...
  function handleUpdate (e){
    ...
    try {
      const dataUser = {
        ...
        email : email,
        location : adresse,
        profile_picture: image ? image.image : null, // add image if it exists, otherwise null
      }
  
      return axios.put(`http://127.0.0.1:8000/api/updateProfile/${data.id}`,dataUser)
      .then(res=>{
        console.log(res)
      })
    }catch(error){
