      ...
      <section>
        ...
        <div class="container my-5">
          ...
          <div class="container mt-30">
            {
              products.map((item) => (
                <div class="col-lg-6 col-lg-12 col-sm-6 d-flex">
                  <div class="row">
                    <div class="col-md-4 col-sm-6">
                      <div class="card mb-30"><a class="card-img-tiles" href="#" data-abc="true">
                        ...
                        <div class="card-body text-center">
                          ...
                          <p class="text-muted">Starting from ${item.price}</p><a class="btn btn-outline-primary btn-sm" href="#" data-abc="true">View Products</a>
                        </div>
                      </div>
                    </div>
                  </div>
