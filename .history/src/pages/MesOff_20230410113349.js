...
const MesOff = () => {
    ...
    useEffect(() => {
        axios.post('http://127.0.0.1:8000/api/getMyOffers',{id:16,seller_id:currentUser.id})
          .then(response =>{
    ...
    useEffect(() => {
      axios.post('http://127.0.0.1:8000/api/getStatusUpdated',{id:16,seller_id:currentUser.id})
        .then(response =>{
          setOffer(response.data.offer)
          console.log(response.data)
        })
