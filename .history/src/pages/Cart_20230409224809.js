                          ...
                          <div class="card-body p-4">
                            <div class="row d-flex justify-content-between align-items-center">
                              ...
                              <div class="col-md-3 col-lg-5 col-xl-1">
                                <button onClick={()=>{addOffer(item.id,priceOffer[index])}} /*onClick={()=>{addOffer(item.id,priceOffer[index])}}*/ type="button" class="btn btn-info text-white btn-md">Send offer</button>
                              </div>
                            </div>
                          </div>
                        </div>
