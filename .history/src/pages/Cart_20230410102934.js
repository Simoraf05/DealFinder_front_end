...
const Cart = () => {
  ...
  const addOffer=({listing_id:listing_id,price:price})=>{
    const data = {
                          ...
                          <div class="card-body p-4">
                            <div class="row d-flex justify-content-between align-items-center">
                              ...
                              <div class="col-md-3 col-lg-3 col-xl-2 d-flex">
                                ...
                                <input id="form1" min="0" name="quantity" value={priceOffer[index] || ''} onChange={(e) => handleQuantityChange(e, index)}  type="number"
                              ...
                              <div class="col-md-1 col-lg-1 col-xl-1 text-end">
                                <button onclick={()=>{deleteFromCart(item.cart_id)}} class="text-danger"><i class="fas fa-trash fa-lg"></i></button>
                              </div>
                              <div class="col-md-3 col-lg-5 col-xl-1">
                                <button onClick={()=>{addOffer({listing_id:item.id,price:priceOffer[index]})}} /*onClick={()=>{addOffer(item.id,priceOffer[index])}}*/ type="button" class="btn btn-info text-white btn-md">Send offer</button>
                              </div>
                            </div>
                          </div>
                        </div>
