...
const Cart = () => {
  ...
  const addOffer=({buyer:buyer_id,listing:listing_id})=>{
    const data = {
      buyer_id:buyer_id,
      listing_id:listing,
      price:priceOffer
                          ...
                          <div class="card-body p-4">
                            <div class="row d-flex justify-content-between align-items-center">
                              ...
                              <div class="col-md-3 col-lg-5 col-xl-1">
                                <button onClick={()=>{addOffer({buyer:item.id,listing:item.card_id})}} type="button" class="btn btn-info text-white btn-md">Send offer</button>
                              </div>
                            </div>
                          </div>
                        </div>
