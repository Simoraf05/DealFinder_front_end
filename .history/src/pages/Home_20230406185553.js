...
const Home = () => {
  ...
  const getImageUrl = (imageBlob) => {
    return console.log(URL.createObjectURL(new Blob([imageBlob])));
  };
  console.log('image',URL.createObjectURL(new Blob([products.image])))
  return (
    <div>
      <Navbar></Navbar>
              ...
              <div class="row">
                {
                  products.map((item)=>(
                    ...
                    <div class="card w-100 my-2 shadow-2-strong">
                      <img src={getImageUrl(item.image)} class="card-img-top"  />
