...
const MesCommandes = () => {
  ...
  const checkO =({name:name,price : price,product_picture : product_picture})=>{
    const data = {
      name : name,
      price : price,
      product_picture : product_picture,
    }
    navigate('/checkO',{state:{}})
  }
                              ...
                              <div class="col-md-3 col-lg-2 col-xl-2 offset-lg-1">
                                {
                                    ...
                                    :
                                    <button type="button" onClick={()=>{checkO({name:item.title,price : item.price,product_picture : item.product_picture})}} class="btn btn-primary">CheckOut</button>
                                }
