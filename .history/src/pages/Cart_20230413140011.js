...
const Cart = () => {
  ...
  const addOffer=({listing_id:listing_id,price:price,seller:seller})=>{
    ...
    const config = {
     /* Username : 'simorafsi309@gmail.com',
      Password : '6A4235916B2EFE4F01F39F32330C9032174B',
      Server : 'smtp.elasticemail.com',
      Port : 2525,*/
      SecureToken : 'a4db7845-f0a2-4245-8a81-ab111ee26c70',
      To : 'bennawoboile-5709@yopmail.com',
                          ...
                          <div class="card-body p-4">
                            <div class="row d-flex justify-content-between align-items-center">
                              ...
                              <div class="col-md-3 col-lg-5 col-xl-1">
                                <button onClick={()=>{addOffer({listing_id:item.id,price:priceOffer[index],seller:item.email})}} /*onClick={()=>{addOffer(item.id,priceOffer[index])}}*/ type="button" class="btn btn-info text-white btn-md">Send offer</button>
                              </div>
                            </div>
                          </div>
                        </div>
