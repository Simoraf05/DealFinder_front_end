...
const MesCommandes = () => {
  ...
  const updateOfferPrice=(e)=>{
    e.preventDefault()
    try{
      const response = axios.post(`http://127.0.0.1:8000/api/updatingOfferPrice/${commande.offer_id}`)
                              ...
                              <div class="col-md-3 col-lg-2 col-xl-2 offset-lg-1">
                                {
                                    ...
                                    <button type="button" onClick={updateOfferPrice} class="btn btn-success">update offer price</button>
                                    :
