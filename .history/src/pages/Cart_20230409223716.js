                          ...
                          <div class="card-body p-4">
                            <div class="row d-flex justify-content-between align-items-center">
                              ...
                              <div class="col-md-3 col-lg-3 col-xl-2 d-flex">
                                ...
                                <input id="form1" min="0" name="quantity" defaultValue={item.price} value={priceOffer[index] || ''} onChange={(e) => handleQuantityChange(e, index)}  type="number"
                              ...
                              <div class="col-md-3 col-lg-5 col-xl-1">
                                <button  onClick={() => console.log(priceOffer)} type="button" class="btn btn-info text-white btn-md">Send offer</button>
                              </div>
                            </div>
                          </div>
                        </div>
