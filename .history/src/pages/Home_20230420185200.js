...
const Home = () => {
  ...
  useEffect(() => {
    const dataFetch = async () =>{
      const products = await (
        await fetch('http://127.0.0.1:8000/api/checkStock')
      ).json()
      setStockStatus(products.Product)
    }
    dataFetch();
  },['http://127.0.0.1:8000/api/checkStock'])
                  ...
                  products.map((item)=>(
                    ...
                    <div class="card w-100 my-2 shadow-2-strong">
                    {
                      ...
                      stockStatus.map(stock=>(
                        ...
                        <span class="offer">In stock</span> :
                        <span class="offer">Out of stock</span>
