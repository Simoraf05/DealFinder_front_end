                        ...
                        <div class="card rounded-3 mb-4">
                          <div class="card-body p-4">
                            <div class="row d-flex justify-content-between align-items-center">
                              ...
                              <div id='toolip' class="col-md-3 col-lg-3 col-xl-3">
                                <p id='buyer_info_name'><span  class="text-muted">name: </span>{item.buyer_name}</p>
                                <p id='buyer_info_email'><span  class="text-muted">email: </span>{item.email}</p>
